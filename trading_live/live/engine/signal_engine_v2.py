...
# features, liquidity, scoring) live under research/xauusd-liquidity-sweep/src/.
_RESEARCH = Path(__file__).resolve().parent.parent.parent / "research" / "xauusd-liquidity-sweep"
