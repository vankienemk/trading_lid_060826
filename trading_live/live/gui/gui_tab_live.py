...
class LiveControlTab(QWidget):
    ...
    def _on_send_order(self, signal_id: str, lot_size: Optional[float] = None) -> bool:
...
class _InspectLoadWorker(QObject):
    ...
    def __init__(self, bridge: SystemBridge, asset: str, limit: int = 50,
                 risk: Optional[tuple] = None, parent: Optional[QObject] = None) -> None:
        super().__init__(parent)
        self._bridge = bridge
        self._asset = asset
        self._limit = limit
...
class SignalInspectDialog(QDialog):
    ...
    def __init__(self, bridge: SystemBridge, signal: Dict[str, Any],
                 send_callback: Callable[[str, Optional[float]], bool],
