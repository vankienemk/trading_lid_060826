...
class SystemBridge:
    ...
    def __init__(self, config_path: Optional[str] = None) -> None:
        ...
        # -------------------------------
        # Load validated symbols from YAML configs
        # -------------------------------
    ...
    def _load_symbol_configs(self) -> None:
        ...
        Only symbols with status=validated are registered here.
        MCP-discovered symbols remain in the registry at their existing status
        (never downgraded by MCP poll).
        """
        ...
        for yaml_file in sorted(configs_dir.glob("*.yaml")):
            ...
            try:
                ...
                if status == "validated":
                    ...
                    if cfg is None or cfg.status != "validated":
